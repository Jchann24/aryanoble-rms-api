                                ...
                                <td class="wrapper">
                                    <table role="presentation"
                                        ...
                                        <tr>
                                            <td>
                                                <p>Hi,</p>
                                                <p>You Received a Form Attachment! If you can see this email, please
                                                    download the attachment provided!</p>
                                                <a href="{{env('FRONTEND_URL')}}"
                                                   target="_blank"
                                                   rel="noopener">
                                                    Login for more details -> {{env('FRONTEND_URL')}}
                                                </a>
                                                <br />
                                                <table role="presentation"
                                                       border="0"
                                                ...
                                                <p>This is a really simple email template. Its sole purpose is to get
